...
class ActivityQuiz : BaseActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            hintBtn.setOnClickListener(){
                if (connect.isConnectedToInternet(this@ActivityQuiz)) {
                        ...
                        if(it.exists()){
                            ...
                            if(score >= 5){
                                ...
                                databaseRefScore.child(user).setValue(newScore).addOnCompleteListener(){
                                    ...
                                    Toast.makeText(this@ActivityQuiz,"Error in updating user account, try again!", Toast.LENGTH_SHORT).show()
                            ...
                            Toast.makeText(this@ActivityQuiz,"Cannot retrieve your score, try again later!!", Toast.LENGTH_SHORT).show()
                        }
                    }.addOnFailureListener(){
                    ...
                    Toast.makeText(this@ActivityQuiz,"You are offline, make sure to sync your score later!", Toast.LENGTH_SHORT).show()

                    if(ScorePreferences.getScore() >= 5){
                        hintText.visibility = View.VISIBLE
                        hintBtn.visibility = View.GONE

                        ScorePreferences.decrementScore()
                    }
                    else{
                        Toast.makeText(this@ActivityQuiz,"You do not have enough points for a hint!", Toast.LENGTH_SHORT).show()
                    }
        ...
        dialogBinding.apply {
            ...
            if(percentage>60){
                ...
                if (connect.isConnectedToInternet(this@ActivityQuiz)) {
                    ...
                    ScorePreferences.incrementScore()
                }
