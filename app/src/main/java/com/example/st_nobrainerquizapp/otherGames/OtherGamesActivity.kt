        ...
        binding?.apply {
            ...
            bottomNavigation.setOnNavigationItemSelectedListener { item ->
                when (item.itemId) {
                    ...
                    R.id.nav_board -> {
                        startActivity(Intent(this@OtherGamesActivity, ActivityScoreboard::class.java))
